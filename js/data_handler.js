...
fetch('./data/shotsinfo.json').then((response) => response.json()).then((json) => readShotsJson(json));
fetch('./data/teamsinfo.json').then((response) => response.json()).then((json) => readTeamsJson(json));
